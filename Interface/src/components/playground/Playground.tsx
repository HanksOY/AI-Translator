...
export default function Playground({
  ...
  const videoTileContent = useMemo(() => {
    ...
    return (
      <div className="flex flex-col w-full grow text-gray-950 rounded-sm border border-gray-800 relative" style={{ background: 'linear-gradient(to bottom, #ADD8E6, #8EC5D6)' }}>
        {content}
      </div>
    );
    ...
    <>
      ...
      >
        ...
        <PlaygroundTile
          ...
          childrenClassName="h-full grow items-start"
          style={{ background: 'linear-gradient(to bottom, #ADD8E6, #8EC5D6)' }}
        >
          {settingsTileContent}
        </PlaygroundTile>
      </div>
